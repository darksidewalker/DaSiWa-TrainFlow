...
try:
    ...
    from musubi_tuner.ltx_2.loader.kernels import fused_add_round_kernel
    ...
    _HAS_TRITON = False
from musubi_tuner.ltx_2.loader.primitives import LoraStateDictWithStrength, StateDict
